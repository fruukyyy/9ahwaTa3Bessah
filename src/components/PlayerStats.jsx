          ...
          {comparedPlayers.map(player => (
            <div key={player.id} className="flex items-center bg-primary/50 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full border border-gold-500/30">
              <img 
                src={player.image} 
                alt={player.name} 
                className="w-5 h-5 sm:w-6 sm:h-6 rounded-full mr-1 sm:mr-2 border border-gold-500"
              />
                ...
                <div key={player.id} className="bg-primary p-3 sm:p-4 rounded-lg border border-gold-500/30">
                  <div className="flex items-center mb-2 sm:mb-3">
                    <img 
                      src={player.image} 
                      alt={player.name} 
                      className="w-10 h-10 sm:w-12 sm:h-12 rounded-full mr-2 sm:mr-3 border-2 border-gold-500"
                    />
                    <div>
                  ...
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                    ...
                    >
                      <img 
                        src={player.image} 
                        alt={player.name} 
                        className="w-8 h-8 sm:w-10 sm:h-10 rounded-full mr-2 sm:mr-3 border-2 border-gold-500 group-hover:border-gold-300 transition-colors"
                      />
                      <div>
